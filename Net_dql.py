# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 09:32:20 2019
用来实现布洛赫球面上的归零操作
@author: Waikikilick
"""
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net',reuse=None):
            c_names, n_l1, n_l2, w_initializer, b_initializer = \
                ['eval_net_params', tf.GraphKeys.GLOBAL_VARIABLES], 20, 20, tf.random_normal_initializer(0., 0.3), tf.constant_initializer(0.1)  # config of layers
...
#                
#            with tf.variable_scope('l4',reuse=None):
...
#                self.q_next = tf.matmul(l1, w2) + b2        
    ...
    def choose_action(self, observation,tanxin):
